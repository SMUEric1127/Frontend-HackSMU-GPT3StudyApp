...
import QuizSkeleton from "../components/cards/SkeletonCard";
      ...
      >
        <View style={styles.quizTakingView}>
          ...
          {/* <Carousel
            width={width}
            height={200}
            data={[...new Array(quizzesState.length).keys()]}
            onSnapToItem={(index) => console.log("current index:", index)}
            renderItem={({ index }) => (
              <View style={{ backgroundColor: "red" }}>
                <FlippedCard
                  question={quizzesState[index].question}
                  answer={quizzesState[index].answer}
                  key={index}
                />
              </View>
            )}
          ...
          >
            {quizzesState.map((element, index) => {
              console.log("+=====+");
              // console.log(Array(quizzesState.length()));
              console.log(element);
            ...
            <View style={styles.innerContent}>
              ...
              <ScrollView style={styles.scrollView} horizontal>
                {chatContext.quizSets.map((quizSet, index) => {
                  return (
                    <Animated.View entering={FadeIn} key={index}>
                      <QuizSelectionCard
                        title={"Quiz " + (index + 1)}
              ...
              <View>
                ...
                <Animated.View style={styles.scrollView} entering={FadeInDown}>
